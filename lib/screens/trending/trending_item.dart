...
class TrendingItem extends StatefulWidget {
  ...
  const TrendingItem({Key key, this.document, this.userId, this.id, this.views})
      : super(key: key);
  ...
  Widget trendingitemWidget(bool hover, String mediaUrl, String extension,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: Colors.white,
        border: Border.all(
          color: hover ? Colors.blueAccent : Colors.grey[400],
        ),
      ),
      child: Column(
        children: [
                      ...
                      Expanded(
                        child: StreamBuilder<QuerySnapshot>(
                          stream: users
                              ...
                              .collection("Pub")
                              .doc(id)
                              .collection(postKind != "broadcasting" &&
                                      postKind != "inPic"
                                  ? "Readers"
                                  : "Views")
                              .snapshots(),
          ...
          postKind != "personality" &&
              ...
              ? Container(
                  ...
                  child: Row(
                    children: [
                      ConstrainedBox(
                        constraints: BoxConstraints(maxHeight: h * .045),
                        child: Container(
