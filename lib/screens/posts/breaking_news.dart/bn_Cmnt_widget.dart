...
class BreakingNewsCommentWidget extends StatefulWidget {
  ...
  const BreakingNewsCommentWidget({
    Key key,
    this.commentContent,
    this.timeAgo,
    this.userId,
  ...
  @override
  _BreakingNewsCommentWidgetState createState() =>
      _BreakingNewsCommentWidgetState();
}

class _BreakingNewsCommentWidgetState extends State<BreakingNewsCommentWidget> {
  bool reply = false;
  String userId;
  String commentId;
  String documentId;
